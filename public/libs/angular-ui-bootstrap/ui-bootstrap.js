...
.directive('uibAccordion', function() {
  return {
    ...
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/accordion/accordion.html';
    }
  };
})
...
.directive('uibAccordionGroup', function() {
  return {
    ...
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/accordion/accordion-group.html';
    },
    scope: {
...
.directive('uibAlert', function() {
  return {
    ...
    controllerAs: 'alert',
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/alert/alert.html';
    },
    transclude: true,
    replace: true,
    scope: {
...
.directive('uibCarousel', function() {
  return {
    ...
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/carousel/carousel.html';
    },
    scope: {
      active: '=',
      interval: '=',
...
.directive('uibSlide', function() {
  return {
    ...
    replace: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/carousel/slide.html';
    },
    scope: {
      actual: '=?',
      index: '=?'
...
.directive('uibDatepicker', function() {
  return {
    replace: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/datepicker/datepicker.html';
    },
    scope: {
      datepickerMode: '=?',
      datepickerOptions: '=?',
...
.directive('uibDaypicker', function() {
  return {
    replace: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/datepicker/day.html';
    },
...
.directive('uibMonthpicker', function() {
  return {
    replace: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/datepicker/month.html';
    },
...
.directive('uibYearpicker', function() {
  return {
    replace: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/datepicker/year.html';
    },
...
.constant('uibDatepickerPopupConfig', {
  ...
  datepickerPopupTemplateUrl: 'libs/angular-ui-bootstrap/uib/template/datepicker/popup.html',
  datepickerTemplateUrl: 'libs/angular-ui-bootstrap/uib/template/datepicker/datepicker.html',
  html5Types: {
    date: 'yyyy-MM-dd',
...
.directive('uibDatepickerPopupWrap', function() {
  return {
    ...
    transclude: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/datepicker/popup.html';
    }
  };
});
 ...
 */
  ...
  function($animate, $injector, $modalStack) {
    return {
      replace: true,
      templateUrl: 'libs/angular-ui-bootstrap/uib/template/modal/backdrop.html',
      compile: function(tElement, tAttrs) {
  ...
  function($modalStack, $q, $animateCss, $document) {
    return {
      ...
      templateUrl: function(tElement, tAttrs) {
        return tAttrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/modal/window.html';
      },
      link: function(scope, element, attrs) {
...
.directive('uibPager', ['uibPagerConfig', function(uibPagerConfig) {
  return {
    ...
    controllerAs: 'pager',
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/pager/pager.html';
    },
    replace: true,
    link: function(scope, element, attrs, ctrls) {
...
.directive('uibPagination', ['$parse', 'uibPaginationConfig', function($parse, uibPaginationConfig) {
  return {
    ...
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/pagination/pagination.html';
    },
    replace: true,
    link: function(scope, element, attrs, ctrls) {
      var paginationCtrl = ctrls[0], ngModelCtrl = ctrls[1];
...
.directive('uibTooltipPopup', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/tooltip/tooltip-popup.html'
  };
})
...
.directive('uibTooltipTemplatePopup', function() {
  return {
    ...
    scope: { contentExp: '&', placement: '@', popupClass: '@', animation: '&', isOpen: '&',
      originScope: '&' },
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/tooltip/tooltip-template-popup.html'
  };
})
...
.directive('uibTooltipHtmlPopup', function() {
  return {
    replace: true,
    scope: { contentExp: '&', placement: '@', popupClass: '@', animation: '&', isOpen: '&' },
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/tooltip/tooltip-html-popup.html'
  };
})
...
.directive('uibPopoverTemplatePopup', function() {
  return {
    ...
    scope: { title: '@', contentExp: '&', placement: '@', popupClass: '@', animation: '&', isOpen: '&',
      originScope: '&' },
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/popover/popover-template.html'
  };
})
...
.directive('uibPopoverHtmlPopup', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/popover/popover-html.html'
  };
})
...
.directive('uibPopoverPopup', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/popover/popover.html'
  };
})
...
.directive('uibProgress', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/progressbar/progress.html'
  };
})
...
.directive('uibBar', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/progressbar/bar.html',
...
.directive('uibProgressbar', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/progressbar/progressbar.html',
    link: function(scope, element, attrs, progressCtrl) {
...
.directive('uibRating', function() {
  return {
    ...
    templateUrl: 'libs/angular-ui-bootstrap/uib/template/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs, ctrls) {
...
.directive('uibTabset', function() {
  return {
    ...
    controllerAs: 'tabset',
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/tabs/tabset.html';
    },
    link: function(scope, element, attrs) {
...
.directive('uibTab', ['$parse', function($parse) {
  return {
    ...
    replace: true,
    templateUrl: function(element, attrs) {
      return attrs.templateUrl || 'libs/angular-ui-bootstrap/uib/template/tabs/tab.html';
    },
    transclude: true,
    scope: {
      heading: '@',
...
.constant('uibTimepickerConfig', {
  ...
  arrowkeys: true,
  showSpinners: true,
  templateUrl: 'libs/angular-ui-bootstrap/uib/template/timepicker/timepicker.html'
})
 ...
 */
  ...
  .directive('uibTypeaheadPopup', ['$$debounce', function($$debounce) {
    return {
      ...
      replace: true,
      templateUrl: function(element, attrs) {
        return attrs.popupTemplateUrl || 'libs/angular-ui-bootstrap/uib/template/typeahead/typeahead-popup.html';
      },
      link: function(scope, element, attrs) {
  ...
  .directive('uibTypeaheadMatch', ['$templateRequest', '$compile', '$parse', function($templateRequest, $compile, $parse) {
    return {
      ...
      link: function(scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || 'libs/angular-ui-bootstrap/uib/template/typeahead/typeahead-match.html';
